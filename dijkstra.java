...
class RutaMasCorta {
	...
	void dijkstra(int grafo[][], int fuente){
		...
		for(contador=0 ; contador<V-1 ; contador++){
			...
			// de lo contrario cuando se evalúa el grafo[][] el
			// algoritmo no funcionará, porque se usa un indice_max = 9.
	...
	public static void main(String[] args){
		...
		int grafo[][] = new int[][]{{0	, 4	, 0	, 0	, 0	, 0	, 0	, 8	, 0	},		// V0
									...
									{0	, 0	, 2	, 0	, 0	, 0	, 6	, 7	, 0	}		// V8
								};

		RutaMasCorta ruta = new RutaMasCorta();

		// Nueve vértices númerados del 0 al 8.
...
// El código calcula la distancia más corta, pero no calcula la información de la ruta. 

// Para fuente igual a vertice 0 imprime:
// Distancia desde el vertice 0 al 0: 0
// Distancia desde el vertice 0 al 1: 4		---- V0 -> V1
// Distancia desde el vertice 0 al 2: 12	---- V0 -> V1 -> V2
// Distancia desde el vertice 0 al 3: 19	---- V0 -> V1 -> V2 -> V3
// Distancia desde el vertice 0 al 4: 21	---- V0 -> V7 -> V6 -> V5 -> V4
// Distancia desde el vertice 0 al 5: 11	---- V0 -> V7 -> V6 -> V5
// Distancia desde el vertice 0 al 6: 9		---- V0 -> V7 -> V6
// Distancia desde el vertice 0 al 7: 8		---- V0 -> V7
// Distancia desde el vertice 0 al 8: 14	---- V0 -> V1 -> V2 -> V8


// Para fuente igual a vertice 5 imprime:
// Distancia desde el vertice 5 al 0: 11	---- V5 -> V6 -> V7 -> V0
// Distancia desde el vertice 5 al 1: 12	---- V5 -> V2 -> V1
// Distancia desde el vertice 5 al 2: 4		---- V5 -> V2
// Distancia desde el vertice 5 al 3: 11	---- V5 -> V2 -> V3
// Distancia desde el vertice 5 al 4: 10	---- V5 -> V4
// Distancia desde el vertice 5 al 5: 0
